...
require_once($CFG->dirroot . '/mod/newsletter/backup/moodle2/restore_newsletter_stepslib.php'); // Because it exists (must).

/**
 * newsletter restore task that provides all the settings and steps to perform one
...
class restore_newsletter_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_newsletter_activity_structure_step('newsletter_structure', 'newsletter.xml'));
    }
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('newsletter', 'view', 'view.php?id={course_module}', '{newsletter}');
        $rules[] = new restore_log_rule('newsletter', 'view newsletter', 'view.php?id={course_module}', '{newsletter}');
