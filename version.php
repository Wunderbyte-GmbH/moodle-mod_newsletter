...
$plugin->version   = 2021052600;        // If version == 0 then module will not be installed
$plugin->requires  = 2018051700;        // Requires this Moodle version
$plugin->maturity  = MATURITY_STABLE;   // Maturity
$plugin->release   = 'v2.1-NewYorkTimes';  // Already used names: Der Standard, Le Monde Diplomatique
