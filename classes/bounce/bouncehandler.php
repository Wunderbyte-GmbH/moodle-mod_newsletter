...
class bouncehandler
{
     ...
     * @var array
     */
    protected $_counter_result = array(
        'total'        => 0,
        'fetched'      => 0,
        'processed'    => 0,
        'unprocessed'  => 0,
     ...
     *   integer	'date'		   unix timestamp of received date
     *   array      'recipients'   see $_recipient_result.
     * @var array
     */
    protected $_msg_result = array(
        'token'       => null,
        'processed'   => true,
        'subject'     => null,
        'type'        => null,
     ...
     * @var array
     */
    protected $_recipient_result = array(
        'action'      => null,
        'status'      => null,
        'email'       => null,
        'bounce_type' => null,
     ...
     * @var array
     */
    protected $_status_result = array(
        'code'                        => null,
     ...
     * @var array
     */
    protected $_status_code_resolver = array
    (
        // get from regexp
        '[45]\d\d[- ]\#?([45]\.\d\.\d)'                                 => 'x',
     ...
     * @var array
     */
    protected $_rule_cat_resolver = array
    (
     ...
     */
    protected function output($msg=false, $verbose_level=CWSMBH_VERBOSE_SIMPLE, $newline=true, $code=false)
    {
     ...
     * @return array
     */
    protected function processParsing($token, $content)
    {
     ...
     * @return boolean
     */
    protected function processDelete($token)
    {
        if ($this->isImapOpenMode()) {
     ...
     * @return boolean
     */
    protected function processMove($token, $type)
    {
        if ($this->isImapOpenMode()) {
     ...
     * @return boolean
     */
    protected function isImapOpenMode()
    {
     ...
     * @return boolean
     */
    protected function isMailboxExists($mailbox, $create=true)
    {
     ...
     * @return array
     */
    protected function parseHeader($ar_header)
    {
     ...
     * @return array
     */
    protected function parseBodySectionMachine($body_section_machine)
    {
     ...
     * @return array
     */
    protected function parseDsnFields($body_section_machine)
    {
        $result = array(
            'mime_header'   => null,
            'per_message'   => null,
     ...
     * @return array
     */
    protected function parseLines($content)
    {
        $result = array();
        if (!is_array($content)) {
            $content = explode("\r\n", $content);
     ...
     * @return boolean
     */
    protected function isBounce($ar_header)
    {
        if (!empty($ar_header)) {
     ...
     * @return boolean
     */
    protected function isFbl($ar_header, $body_sections=array())
    {
        if (!empty($ar_header)) {
     ...
     * @return boolean
     */
    protected function isHotmailFbl($body_sections)
    {
     ...
     * @return boolean
     */
    protected function isRfc1892Report($ar_header)
    {
        if (!empty($ar_header)) {
     ...
     * @return array
     */
    protected function formatFinalRecipient($final_recipient){
        $result = array(
            'addr'    => '',
            'type'    => '',
        );
     ...
     * @return array
     */
    protected function formatOriginalRecipient($original_recipient){
        $result = array(
            'addr'    => '',
            'type'    => '',
        );
     ...
     * @return array
     */
    protected function formatDiagnosticCode($diag_code){
        $result = array(
            'type'    => '',
            'text'    => '',
        );
     ...
     * @return string
     */
    protected function findEmail($rcpt)
    {
     ...
     * @return array
     */
    protected function findEmails($body_section_first)
    {
        $result = array();
     ...
     * @return string
     */
    protected function findActionByStatusCode($status_code)
    {
        $result = null;
