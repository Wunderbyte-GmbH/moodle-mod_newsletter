...
class mod_newsletter_resubscribe_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'resubscribe_header', get_string('resubscribe', 'mod_newsletter'));

        $mform->addElement('html', '<p><br />' . get_string('resubscribe_text', 'mod_newsletter') . '</p>');
