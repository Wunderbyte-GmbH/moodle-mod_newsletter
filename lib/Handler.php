...
use MailBounceHandler\Models\Mail;
use MailBounceHandler\Models\Recipient;
...
class Handler
{
    ...
    /**
     * Set the mailbox service to IMAP true, false to pop3
     */
    public function setImapMailboxService($imap = true)
    {
        if ($imap) {
